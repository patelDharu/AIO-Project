...
class feedback_(admin.ModelAdmin):
    list_display = ['id','customer_id','product_name','content','rating','created_at','updated_at']
...
class product_(admin.ModelAdmin):
    list_display = ['product_id','seller_id','name','description','price','sub_category','stock','offer','gallery']
...
class Order_(admin.ModelAdmin):
    ...
    def generate_report(self, request):
        ...
        order_data = [['User Name', 'Product Name','Order Total', 'Booked Date']]
        for order in orders:
